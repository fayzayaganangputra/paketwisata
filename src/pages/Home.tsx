          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                location: "Surabaya",
                rating: 5,
                comment: "Liburan keluarga ke Bali jadi sangat berkesan. Itinerary fleksibel dan sesuai budget. Tim Laju Tuju sangat membantu dari awal sampai akhir perjalanan.",
