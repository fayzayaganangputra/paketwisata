...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      comment: "Liburan keluarga ke Bali jadi sangat berkesan. Itinerary fleksibel dan sesuai budget. Tim Laju Tuju sangat membantu dari awal sampai akhir perjalanan. Anak-anak senang sekali dengan destinasi yang dipilih.",
    ...
    },
    {
      ...
      comment: "Sewa mobil untuk acara keluarga di Jogja. Mobil bersih, driver sangat ramah dan tahu betul jalan-jalan di Jogja. Pelayanan customer service juga responsif. Terima kasih Laju Tuju!",
    ...
    },
    {
      ...
      comment: "Pertama kali ke Semarang dan tidak menyesal pilih Laju Tuju. Destinasi wisata yang dipilih bagus-bagus, mulai dari Kota Lama sampai Lawang Sewu. Driver juga kasih rekomendasi kuliner enak!",
